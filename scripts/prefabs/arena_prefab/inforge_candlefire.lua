...
local function InitEnvelope()
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(102, 60, 187, 128) },
            { .49,  IntColour(102, 60, 187, 128) },
            { .5,   IntColour(0, 89, 255, 128) },
            { .51,  IntColour(94, 30, 255, 128) },
            { .75,  IntColour(126, 28, 255, 128) },
            { 1,    IntColour(73, 8, 252, 0) },
        }
    )
...
return MakeTorchFire("inforge_candlefire", assets, nil, common_postinit, master_postinit)
